...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="formList">
           <s:iterator value="#listTaskView">
			<tr class="TableDetail1 template">
				<td><s:a action="flowAction_approveUI?taskId=%{task.id}&applicationId=%{applicationInfo.id}">${applicationInfo.title}</s:a></td>
				<td>${applicationInfo.applicant.realName}&nbsp;</td>
				 
				<td><s:date name="applicationInfo.applyTime" format="yyyy-MM-dd hh:mm"/>&nbsp;</td>
				<td><s:a action="flowAction_approveUI?taskId=%{task.id}&applicationId=%{applicationInfo.id}">审批处理</s:a>
					<!-- <a href="showForm.html">查看申请信息</a> -->
					<s:a action="flowAction_approveHistory?applicationId=%{applicationInfo.id}">查看流转记录</s:a>
				</td>
			</tr>
			</s:iterator>
        </tbody>
