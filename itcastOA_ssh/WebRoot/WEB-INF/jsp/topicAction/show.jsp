...
<div id="MainArea">
	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%">
			...
			<font class="MenuPoint"> &gt; </font>
			<s:a action="forumAction_show?id=%{#topic.forum.id}">${topic.forum.forumName}</s:a>
			<font class="MenuPoint"> &gt;&gt; </font>
			帖子阅读
			<span style="margin-left:30px;"><s:a action="topicAction_addUI?forumId=%{#topic.forum.id}">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						<s:a class="detail" action="replyAction_addUI?topicId=%{#topic.id}"><img border="0" src="${pageContext.request.contextPath}/style/images/reply.gif" />回复</s:a>
						 <s:if test="#session.user.loginName=='admin' ">
						<s:a action="topicAction_moveUI?id=%{#topic.id}"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />移动到其他版块</s:a>
						<s:a action="topicAction_setTopicType?typeId=1&&id=%{#topic.id}" onClick="return confirm('要把本主题设为精华吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/forum_hot.gif" />精华</s:a>
						<s:a action="topicAction_setTopicType?typeId=2&&id=%{#topic.id}" onClick="return confirm('要把本主题设为置顶吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/forum_top.gif" />置顶</s:a>
						<s:a action="topicAction_setTopicType?typeId=0&&id=%{#topic.id}" onClick="return confirm('要把本主题设为普通吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/forum_comm.gif" />普通</s:a>
						</s:if>
					</td>
				...
				<table border="0" cellpadding="0" cellspacing="1" width="100%">
					<tr>
						<td rowspan="3" width="130" class="PhotoArea" align="center" valign="top">
							...
							<!--作者名称-->
							<div class="AuthorName">${topic.author.realName}</div>
						</td>
						<td align="center">
							<ul class="TopicFunc">
								<!--操作列表-->
						...
						<td class="Footer" height="28" align="center" valign="bottom">
							<ul style="margin: 0px; width: 98%;">
								<li style="float: left; line-height:18px;"><font color=#C30000>[楼主]</font>
									 <s:date name="%{#topic.postTime}" format="yyyy-MM-dd hh:mm"/>
								</li>
				   ...
				   <s:iterator value="recordList" status="status">
					<tr>
						<td rowspan="3" width="130" class="PhotoArea" align="center" valign="top">
							...
							<!--作者名称-->
							<div class="AuthorName">${author.realName}</div>
						</td>
						<td align="center">
							<ul class="TopicFunc">
								<!--操作列表-->
			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				<tr height="30" class="Tint">
					...
					<td class="no_color_bg">
					    <s:textfield name="title" cssClass="InputStyle" value="回复:%{#topic.title}" cssStyle="width:90%"></s:textfield>
					</td>
				</tr>
				<tr height="30" class="Tint">
