...
<div id="MainArea">
        ...
        <tbody id="TableData" class="dataContainer" datakey="documentTemplateList">
          <s:iterator value="#applicationTemplateList">
			<tr class="TableDetail1 template">
					<td><a href="javascript:void('下载')">${templateName}</a>&nbsp;</td>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
			<s:a action="applicationTemplateAction_addUI.action"><img src="${pageContext.request.contextPath}/style/blue/images/button/addNew.png" /></s:a>
        </div>
    </div>
