				...
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
							    <s:select name="departmentId" list="#ListDepartment" cssClass="SelectStyle"
						...
						<tr>
							<td>登录名</td>
							<td><s:textfield name="loginName" cssClass="InputStyle required"></s:textfield>
								* （登录名要唯一）</td>
						</tr>
						<tr>
							<td>姓名</td>
							<td><s:textfield name="realName" cssClass="InputStyle required"></s:textfield>*</td>
						</tr>
						<tr>
							<td>性别</td>
							<td>
